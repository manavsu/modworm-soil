...
<div class=relative>
    <div class="fixed bg-black top-0 left-0 flex flex-row justify-between p-5 w-screen items-center z-10 bg-opacity-90">
        <a href="/" class="text-xl pl-10 text-center text-gray-400 hover:text-white opacity-100">{ip}:{port}</a>
        ...
        <div class="flex flex-col justify-center items-center">
            <form class="flex flex-row" on:submit={update_map}>
                ...
                <button class="text-3xl px-5 mr-10 text-gray-500 hover:text-white">&rarr;</button>
            </form>
        </div>
    </div>
